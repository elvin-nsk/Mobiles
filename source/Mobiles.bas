...
Public Const PrimaryCategoryCaptionPrefix As String = "СБОРКА"
Public Const SecondaryCategoryCaptionPrefix As String = "ДОПОЛНИТЕЛЬНАЯ СБОРКА"
Public Const SecondaryCategoryNameSuffix As String = "_ДОП"
...
Public Const DebugMobilesRootRepalceTo As String = _
  "e:\WORK\макросы Corel\на заказ\Дмитрий Шмыга\Mobiles\материалы\2021-11-29\Data\"
